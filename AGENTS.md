...
| **create-skill** | Creación de skill: rama `feat/create-skill-<skill-id>`. Entregable: definición en paths.skillsDefinitionPath; cápsula en paths.skillCapsules si aplica. | `paths.featurePath/create-skill-<skill-id>` (doc); definición en `paths.skillsDefinitionPath/<skill-id>/`; cápsula en `paths.skillCapsules` | [`SddIA/process/create-skill/`](./SddIA/process/create-skill/) |
...
| **[CREATE-SKILL]** | Skill, Crear skill, Nueva skill, Skill ejecutable. | Cargar [`SddIA/process/create-skill/`](./SddIA/process/create-skill/). Orquestar ciclo de creación de skill (definición, cápsula opcional, índice, Cúmulo). |
