...
## [2024-03-27] Tarea: Actualizacion_Readme
- Se ha borrado `src/README.md`
- Se ha actualizado el `README.md` principal para reflejar que GesFer Admin es un frontend Next.js aislado que consume una API independiente.
