...
8. **Validate-pull-requests:** paths.processPath/validate-pull-requests/. Ruta doc: Cúmulo (paths.featurePath/validate-pull-requests-&lt;pr-slug&gt;). Semillas Kaizen: paths.tasksPath (o `tasks_path_cumulo` resuelto desde Cúmulo).
