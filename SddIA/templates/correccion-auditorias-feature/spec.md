...
- **Skills:** git-workspace-recon, git-branch-manager, git-save-snapshot, git-sync-remote, git-tactical-retreat, git-create-pr, documentation, security-audit cuando aplique.
